...
`LabConfig` is a discriminated union keyed on `kind` (`"stub" | "simulation" | "observations" | "guided"`). For a lab generated by this skill, always use `kind: "guided"` — the scaffold below assumes that variant.
